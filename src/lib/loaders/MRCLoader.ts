...
export class MRCDataLoader {
  ...
  public parse(data) {
    ...
    function parseStream(_data) {
      ...
      //  size of the image
      const volsize = MRC.nx * MRC.ny * MRC.nz;
    ...
    function scan(type, chunks?) {
      ...
      const _start = _dataPointer;
      const _end = _dataPointer += chunks * _chunkSize;
    ...
    const spacingZ = MRC.zlen / MRC.mz;
